...
function fileDelete2 (startPos){ // flag files to be deleted,recursion
  if (startPos==0){ // root folder protector
    ...
    promptQuestion ("") //go to QUESTIONING
  }
...
function fileOpen (filename){
  ...
  //console.log(fileSystem[getPlaceFromIndex(filename)][0]);
...
action = action.toUpperCase();
  ...
  case "CREATE":
    ...
    if (Create=="file" || Create=="folder" || Create=="File" || Create=="Folder"){

      if (Create=="file" || Create=="File"){
      ...
      if (Create=="Folder" || Create=="folder"){
